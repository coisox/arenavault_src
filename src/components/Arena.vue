	...
	<div class="p-absolute page bg-gradient-green">
		...
		<div class="navbar d-flex">
			...
			<div class="nav-col p-relative d-flex">
				<button class="btn-circle bg-gradient-grey" @click="showModalArena()"><i class="material-icons-outlined v-middle">add</i></button>
			</div>
			<div class="nav-col p-relative d-flex center">
		...
		<div class="content">
			<div class="table-row" v-for="item in arenas" :key="item.ARENA_ID">
				...
				<div class="table-col-3 text-right">
                    <i class="material-icons-outlined red" @click="showModalShare(item.ARENA_ID, item.ARENA_NAME)">share</i>
